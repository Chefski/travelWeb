      ...
      <div class="grid gap-4 py-4">
        ...
        <div class="grid gap-2">
          <div class="flex items-center justify-between gap-2">
            <label for="edit-trip-start-date" class="text-sm font-medium">Travel dates</label>
            <span class="text-xs text-muted-foreground">{{ dateLabel }}</span>
          </div>
          <div class="grid grid-cols-2 gap-2">
            <Input id="edit-trip-start-date" v-model="startDateInput" type="date" aria-label="Start date" />
            <Input id="edit-trip-end-date" v-model="endDateInput" type="date" aria-label="End date" :min="startDateInput || undefined" />
          </div>
        </div>
